...
class LSM303(object):
    ...
    def __init__(self, i2c, hires=True):
        ...
        self._bus.writeto_mem(LSM303_ADDRESS_ACCEL,
        ...
        self._bus.writeto_mem(LSM303_ADDRESS_MAG,
    ...
    def read_accel(self):
        ...
        accel_bytes = self._bus.readfrom_mem_into(LSM303_ADDRESS_ACCEL,
    ...
    def read_mag(self, mag_bytes = bytearray(6)):
        'Read raw magnetic field in microtesla'
        # Read as signed 16-bit big endian values
        self._bus.readfrom_mem_into(LSM303_ADDRESS_MAG,
